...
### NOTA: El contenido de Text Analysis/Voz/Traducción que vivía en este archivo (Q1874-Q1953) se movió a `BANCO PREGUNTAS AI103 PARTE24 TEXT ANALYSIS VOZ TRADUCCION.md` bajo la clave `"Domain 4 (real)"` — es un dominio oficial distinto de este (IA Responsable es subtema del Domain 2 oficial), y compartir la clave `"Domain 4"` era un error de etiquetado.
